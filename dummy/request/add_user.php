  ...
  <body class="h-full">
          ...
          <li>
            <div>
              <a
                aria-expanded="false"
                data-preview-links=""
                href="../request/user_management.php"
    ...
    <main id="main" class="with-side-nav">
      <div class="container">
        ...
        <h3>Add new user</h3>
        <br>
        <form action="../request/process_add_user.php" method="POST">
                <div class="col">
                    <div class="mb-3">
                ...
                <div class="row">
                    <div class="col d-flex justify-content-start">
                        <button type="submit" class="btn btn-success" id="submit_button">Add user</button>
                    </div>

                    <div class="col d-flex justify-content-end">
                        <button type="button" class="btn btn-danger"
                            onclick="window.location.href='../request/user_management.php'">Cancel</button>
                    </div>
                </div>
            </form>
      </div>
