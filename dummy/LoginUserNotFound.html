...
<head>
    ...
    <title>Log In | Prior Authorization Training Site</title>
                    ...
                    <div
                                ...
                                <form id="login-form" class="login-form" action="./process_login.php"
                                    ...
                                    <div class="mdc-text-field mdc-text-field--filled mdc-text-field--full-width"
                                        ...
                                        <input type="text"
                                            ...
                                            required="required" aria-describedby="username-helper-text" name="username"
                                            id="username" />
                        ...
                        id="email error">Please fill up your username</div>-->
                                    ...
                                    <div class="mdc-text-field mdc-text-field--filled mdc-text-field--full-width"
                                        data-mdc-auto-init="MDCTextField">
                                        <div class="mdc-line-ripple"></div>
                                        <label class="mdc-floating-label" for="password" style="padding-bottom:25px;" >Password</label>

                                        <input type="password"
                                            class="mdc-text-field__input mdc-text-field--with-trailing-icon"
                                            required="required" aria-describedby="password-helper-text" name="password"
                                            id="password" />
                        ...
                        id="pass_error">Please fill up your password</div> -->
                                    ...
                                    <div class="spacer__top--medium">
                                        <input type="submit" name="commit" value="Log in" id="login-button"
