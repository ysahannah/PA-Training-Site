...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $provider_sql = "INSERT INTO patient_information (npi, firstName, lastName, street2, street, city, state, zip_code, phone, fax) VALUES ('$npi', '$provider_firstName', '$provider_lastName', '$street2', '$street', '$city', '$provider_state', '$zip_code', '$phone', '$fax')";
