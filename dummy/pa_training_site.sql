...
CREATE TABLE `patient_information` (
  ...
  `patient_insurance_state_id` int(11) DEFAULT NULL,
...
INSERT INTO `patient_information` (`patient_id`, `firstName`, `lastName`, `gender`, `birthday`, `zip_code`, `patient_insurance_state_id`, `patient_address_book_id`, `prefix`, `middle_name`, `suffix`, `member_id`, `medication_id`) VALUES
(46, 'EUGENIA', 'CAROLS', 'female', '1990-03-07 00:00:00', 533453, 13, NULL, NULL, NULL, NULL, NULL, NULL),
(69, 'JOHN', 'DOE', 'male', '1999-05-06 00:00:00', 345345, 0, NULL, NULL, NULL, NULL, NULL, NULL),
(70, 'JOHN', 'YOUNG', 'male', '1987-12-05 00:00:00', 34513245, 0, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
-- Table structure for table `type_of_review`
--

CREATE TABLE `type_of_review` (
  `review_id` int(11) NOT NULL,
  `patient_id` int(11) DEFAULT NULL,
  `review_type` enum('yes','no') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `patient_information`
  ...
  ADD KEY `FK_patient_insurance_state` (`patient_insurance_state_id`),
...
--
-- Indexes for table `type_of_review`
--
ALTER TABLE `type_of_review`
...
ALTER TABLE `patient_insurance_state`
  ...
  ADD CONSTRAINT `patient_insurance_state_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patient_information` (`patient_insurance_state_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
